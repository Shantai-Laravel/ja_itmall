...
var Placeholder = __vue_normalize__({
...
var listWithChildren = function listWithChildren(list, childrenProp) {
  return list.map(function (item) {
    return _objectSpread2({}, item, _defineProperty({}, childrenProp, item[childrenProp] ? listWithChildren(item[childrenProp], childrenProp) : []));
  });
};
  ...
  computed: {
    ...
    listStyles: function listStyles() {
      ...
      if (this.elCopyStyles) {
        listStyles = _objectSpread2({}, listStyles, {}, this.elCopyStyles);
      }
  ...
  methods: {
    ...
    onMouseMove: function onMouseMove(event) {
      ...
      if (!this.elCopyStyles) {
        ...
        this.elCopyStyles = _objectSpread2({}, this.elCopyStyles, {}, transformProps);
...
var VueNestable = __vue_normalize__({
...
var VueNestableHandle = __vue_normalize__({
...
export { VueNestable, VueNestableHandle };
