...
class OrderController_ extends Controller
{
    ...
    public function orderPaymentByMethod($methodId, $amount, $orderId)
    {
        ...
        if (!is_null($order)){
            ...
            $request = $client->post($url, [
                ...
                'json' => [
                    "publicKey" => 'application-ac3fd5ef-a987-42bb-b2c7-fde796faec15',
                    "order" => [
                            "id" => "test-order",
                            "amount" => "3",
                            "currency" =>  "EUR",
            ...
            return redirect('https://payop.com//ro/payment/invoice-preprocessing/'.$invoceId, 303);
        }else{
            abort(404);
        }
    }
        ...
        $request = $client->post($url, [
            ...
            'json' => [
                ...
                "order" => [
                    ...
                    "language" => "en",
                    "resultUrl" => "https://juliaallert.com/",
                    "failPath" =>  "https://juliaallert.com/404"
                ],
        ]);
    ...
    **/
     ...
     public function synchronizeStocks()
     {
         ...
         $getProductsUrl = "https://api.frisbo.ro/v1/organizations/183/products";
