...
class OrderController extends Controller
{
    ...
    **/
     ...
     public function sentOrderToFrisbo($order)
     {
         ...
         $url = "https://api.frisbo_1.ro/v1/organizations/183/orders";
     ...
     {
         dd('vkdfm');
         $loginUrl = "https://api.frisbo_1.ro/v1/auth/login";
     ...
     public function synchronizeStocks($page = 1)
     {
         ...
         $getProductsUrl = "https://api.frisbo_1.ro/v1/organizations/183/products?page=".$page;
     ...
     public function setOrderInvocedStatus($orderId)
     {
         ...
         $url = "https://api.frisbo_1.ro/v1/organizations/183/orders/".$orderId."/process";
     ...
     public function setOrderCanceledStatus($orderId)
     {
         ...
         $url_deleted = "https://api.frisbo_1.ro/v1/organizations/183/orders/". $orderId;
