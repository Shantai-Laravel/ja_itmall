            ...
            <form class="form-reg" role="form" method="POST" action="{{ route('blogs.update', $blog->id) }}" id="add-form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label for="img">Blog Logo</label>
                                <input type="file" name="logo" id="img"/>
                                <br>
                                @if ($blog->img)
                                    <img src="{{ asset('images/blogs/'. $blog->img ) }}" style="width: 60%;">
                                    <input type="hidden" name="logo_old" value="{{ $blog->img }}"/>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                @if ($blog->picture)
                                    <img src="{{ asset('images/blogs/'. $blog->picture ) }}" style="width: 60%;">
                                    <input type="hidden" name="picture_old" value="{{ $blog->picture }}"/>
                                @else
                                    <img src="{{ asset('/admin/img/noimage.jpg') }}" style="width: 60%;">
                                @endif
                                <hr>
