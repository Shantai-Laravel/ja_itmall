        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" disabled value="{{ $order->amount - 15 }} {{ $mainCurrency->abbr }}" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="main_status">
                        <option value="preorder" {{ $order->main_status == 'preorder' ? 'selected' : '' }}>Preorder</option>
                        <option value="payed" {{ $order->main_status == 'payed' ? 'selected' : '' }}>Payed</option>
                        <option value="shipping" {{ $order->main_status == 'shipping' ? 'selected' : '' }}>Shipping</option>
                        <option value="shipped" {{ $order->main_status == 'shipped' ? 'selected' : '' }}>Shipped</option>
                        <option value="cancelled" {{ $order->main_status == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                    </select>
                </div>
                {{-- <div class="form-group">
