...
<div class="card">
    <div class="card-block">
        <div class="row order-tabs-area">
            ...
            <div class="col-md-2">
                <a href="{{ Request::url().'?status=payed' }}" class="btn btn-primary btn-block {{ Request::get('status') == 'payed' ? 'active-btn' : ''}}">Payed Order</a>
            </div>
            <div class="col-md-2">
                <a href="{{ Request::url().'?status=shipping' }}" class="btn btn-primary btn-block {{ Request::get('status') == 'shipping' ? 'active-btn' : ''}}">Shipping Order</a>
            </div>
            <div class="col-md-2">
                <a href="{{ Request::url().'?status=shipped' }}" class="btn btn-primary btn-block {{ Request::get('status') == 'shipped' ? 'active-btn' : ''}}">Shipped Order</a>
            </div>
            <div class="col-md-2">
