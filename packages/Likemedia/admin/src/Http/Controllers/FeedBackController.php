...
class FeedBackController extends Controller
{
    public function index()
    {
        ...
        $feedbacksCron = FeedBack::where('status', 'cron')->get();

        return view('admin::admin.feedBack.index', compact('feedbacks', 'feedbacksNew', 'feedbacksProcesed', 'feedbacksCloose', 'feedbacksCron'));
    }
