    ...
    <div class="filterOpen">
        ...
        <div class="row heightFiltr"  v-for="parameter in category.params" v-if="parameter.property.in_filter == 1">
            ...
            <div class="col-12 optionFiltr">
                <div class="opt" v-if="parameter.property.multilingual == 1">{{ parameter.property.translation.name }}</div>
            ...
            <div class="col-12 optionFiltr">
                <div class="opt" v-if="parameter.property.multilingual == 0">{{ parameter.property.trans_data.name }}</div>
                <div class="optionFiltrOpen size1">
                    <div class="row">
                        <div class="col-12">
    ...
    export default {
        ...
        methods: {
            ...
            handleScroll(data){
                ...
                if (this.page > lastPage && this.repeted == false) {
                    this.page = 1;
                    this.repeted = true;
                }
