    ...
    <tr class="row100">
       ...
       <td class="column-text">
        ...
        <td class="column-select" v-for="param in category.params" v-if="dependeble !== param.property.id">
            <select v-model="properties[param.property.id]" v-if="param.property.type === 'select' || param.property.type === 'checkbox'">
        ...
        <!-- <td class="column-button">
            <p class="text-warning"><small>materials can be added only after saving!</small></p>
        </td> -->
        <td class="column-button">
    ...
    export default {
        ...
        methods: {
            ...
            save(){
                ...
                axios.post('/back/auto-upload-create', {product: this.product, properties: this.properties, propertiesText: this.propertiesText, category_id: this.category.id})
                    .then(response => {
                        bus.$emit('updatePage');
                        this.setDefaultValues();
                        this.getPropValueText();
